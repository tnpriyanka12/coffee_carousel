...
d2 = Drink.create name: "Macchiato" ,milk:"1" ,espresso:"2" ,froth:"A touch" , picture: "assets/macchiato.png", description:"Single espresso with a touch of foam. Macchiato means spotted or stained; the espresso is “stained” with foam. This can be made as a single or a double."
...
d4 = Drink.create name: "Latte" ,milk:"2" ,espresso:"1" ,froth:"thin layer" , picture: "assets/latte.jpg", description:"1/3 espresso, 2/3 hot milk, thin layer of foam. A cafe latte should have the same glossy finish as the cappuccino. This is pulled with a double ristretto."
...
d6 = Drink.create name: "Iced-Coffee" ,milk:"0" ,espresso:"2" ,froth:"None" , picture: "assets/icedcoffee.jpg", description:"A 16-ounce cup of ice with hot-drip coffee poured over it. A double shot of espresso tops it off."
