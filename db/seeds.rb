...
u1 = User.create name: "user1", email:"user1@mail.com", description:"Likes Coffee!" , password: "Chicken1234"
u2 = User.create name: "user2", email:"user2@mail.com", description:"Adores Coffee!!" , password: "Chicken1234"
u3 = User.create name: "user3", email:"user3@mail.com", description:"Loves Coffee!!!!" , password: "Chicken1234"
u4 = User.create name: "user4", email:"user4@mail.com", description:"Lives for Coffee!!!!!!" , password: "Chicken1234"
