...
class DrinksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drink" do
    assert_difference('Drink.count') do
      post drinks_url, params: { drink: { description: @drink.description, froth: @drink.froth, milk: @drink.milk, name: @drink.name, picture: @drink.picture, water: @drink.water } }
    end
  ...
  test "should update drink" do
    patch drink_url(@drink), params: { drink: { description: @drink.description, froth: @drink.froth, milk: @drink.milk, name: @drink.name, picture: @drink.picture, water: @drink.water } }
